...
./deploy/AppRun --appdir=AppDir/ -d AppDir/Smash64Recompiled.desktop -i AppDir/Smash64Recompiled.png -e AppDir/usr/bin/Smash64Recompiled --plugin gtk
...
echo '    APP_FOLDER_PATH=$APP_FOLDER_PATH ./Smash64Recompiled' >> AppDir/AppRun
echo 'else' >> AppDir/AppRun
echo '    cd "$this_dir"/usr/bin/' >> AppDir/AppRun
echo '    ./Smash64Recompiled' >> AppDir/AppRun
